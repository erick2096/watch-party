...
<div class="bg-dark text-secondary px-4 py-5 text-center">
    <div class="py-5">
        <h1 class="display-5 fw-bold text-white"><i class="fa-brands fa-youtube"></i> Watch Videos With Friends</h1>
        ...
        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
            <button type="button" class="btn btn-outline-info btn-md px-4 me-sm-3 fw-bold"><i class="fa-solid fa-square-plus"></i> Create New Room</button>
